...
(function () {
  ...
  const DICT = {
    en: {
      ...
      sec_digital_id: 'Digital ID', id_scan_hint: 'Show this at the site gate for verification',
    ...
    hi: {
      ...
      sec_digital_id: 'डिजिटल आईडी', id_scan_hint: 'सत्यापन के लिए साइट गेट पर यह दिखाएं',
